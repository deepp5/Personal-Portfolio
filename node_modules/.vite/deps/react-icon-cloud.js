...
function _regeneratorRuntime() {
  ...
  function wrap(t2, e2, r2, n3) {
    var i3 = e2 && e2.prototype instanceof Generator ? e2 : Generator, a2 = Object.create(i3.prototype), c2 = new Context(n3 || []);
    return o(a2, "_invoke", {
  ...
  e.wrap = wrap;
  var h = "suspendedStart", l = "suspendedYield", f = "executing", s3 = "completed", y = {};
  function Generator() {
  }
  ...
  function AsyncIterator(t2, e2) {
    function invoke(r3, o2, i3, a2) {
      ...
      if ("throw" !== c2.type) {
        ...
        return h2 && "object" == typeof h2 && n2.call(h2, "__await") ? e2.resolve(h2.__await).then(function(t3) {
  ...
  function makeInvokeMethod(e2, r2, n3) {
    ...
    return function(i3, a2) {
      ...
      for (n3.method = i3, n3.arg = a2; ; ) {
        ...
        if ("normal" === p2.type) {
          if (o2 = n3.done ? s3 : l, p2.arg === y) continue;
          return {
            value: p2.arg,
            done: n3.done
          };
        }
        "throw" === p2.type && (o2 = s3, n3.method = "throw", n3.arg = p2.arg);
      }
    };
  }
  function maybeInvokeDelegate(e2, r2) {
    var n3 = r2.method, o2 = e2.iterator[n3];
    if (o2 === t) return r2.delegate = null, "throw" === n3 && e2.iterator.return && (r2.method = "return", r2.arg = t, maybeInvokeDelegate(e2, r2), "throw" === r2.method) || "return" !== n3 && (r2.method = "throw", r2.arg = new TypeError("The iterator does not provide a '" + n3 + "' method")), y;
    ...
    if (e2 || "" === e2) {
      ...
      if (!isNaN(e2.length)) {
        var o2 = -1, i3 = function next() {
          for (; ++o2 < e2.length; ) if (n2.call(e2, o2)) return next.value = e2[o2], next.done = false, next;
  ...
  return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", {
    ...
    return this;
  }), e.AsyncIterator = AsyncIterator, e.async = function(t2, r2, n3, o2, i3) {
    ...
    delegateYield: function(e2, r2, n3) {
...
var getSlugPath = (function() {
  var _ref2 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(slug) {
...
var getSlugsPath = (function() {
  var _ref2 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(slugs) {
    var map;
...
var fetchSimpleIcons = (function() {
  var _ref2 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(_ref3) {
