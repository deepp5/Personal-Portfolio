...
const profile = {
    name: 'Deep Patel',
    title: 'Software Engineer | Athlete Mindset | Mindset Matters'
    skills: [
        'React', 'NextJS', 'Node', 'Express',
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript',
        'Python', 'GitHub', 'Linux', 'Javascript'
    ],
    hardWorker: true,
    quickLearner: true,
    sportAthlete: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Building products people love 🚀 | Performance, UI, and
                  scalable backend 💻✨
                </p>
              </div> */}
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/deeppatel5/"
                  target="_blank"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1qU7URpkTqULn7tfkRckIKPoYoYrC0KJS/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
